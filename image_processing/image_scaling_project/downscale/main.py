...
expeirment_id = getCurrentDateTimeString()
print(expeirment_id, "(downscaling) has been started...")

results = {}
experiment_folders_path = downscaled_images_folder_path + "/" + expeirment_id
    ...
    for scaling_factor in scaling_factors:
        ...
        for method_name, method in interpolation_methods.items():
            ...
            for i in range(1, SAMPLE_COUNT + 1):
                ...
                downscale_filename = f'{method_name_folder_path}/{i}.bmp'
                cv2.imwrite(downscale_filename, downscaled_image)

                downscale_size_mb = os.path.getsize(downscale_filename) / (1024)
                downscale_image_elapsed_time = end_time - start_time
                sample = {
                    "image_size_kb": downscale_size_mb,
                    "elapsed_time": downscale_image_elapsed_time
                }
...
#report generation
report_experiment_path = "./../report/downscale/" + expeirment_id
