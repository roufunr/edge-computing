...
def load_data():
    data = []
    for i in range(1, 11):
        json_data = load_json("/home/rouf-linux/edge-computing/tx2i_report_generation/raw_data/detection_transfer_sum_time/"+ str(i) +".json")
...
def generate_csv(median):
    for cam in resolutions:
        ...
        create_csv_from_2d_list(rows, "/home/rouf-linux/edge-computing/tx2i_report_generation/csv/sum/" + cam + ".csv")
