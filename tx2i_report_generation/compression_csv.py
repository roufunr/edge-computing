...
def load_data():
    data = []
    for i in range(1, 11):
        json_data = load_json("/home/rouf-linux/edge-computing/tx2i_report_generation/raw_data/compression_time/"+ str(i) +".json")
...
def generate_median(data): 
    median_data = {}
    # compressed/cam1/160x90/INTER_NEAREST/0.1
    ...
    for cam in resolutions:
        ...
        for resolution in resolutions[cam]:
            ...
            for ip_method in ip_methods:
                ...
                row.append("         ")
            rows.append(row)
        create_csv_from_2d_list(rows, "/home/rouf-linux/edge-computing/tx2i_report_generation/csv/compression_time/" + cam + ".json")
