...
def merge_csv_files(csv_file_paths, output_file_path):
    try:
        ...
        for file_path in csv_file_paths:
            ...
            # Append the data with an empty column
            if not merged_data.empty:
                merged_data[''] = ''  # Add an empty column
        ...
        print(f"CSV files have been successfully merged and saved to '{output_file_path}'.")
...
output_csv_path = "/Users/abdurrouf/edge-computing/image_transfer/report_generation/deliverable" + "/" + "compressed_image_transfer.csv"
merge_csv_files(csv_list, output_csv_path)
...
output_csv_path = "/Users/abdurrouf/edge-computing/image_transfer/report_generation/deliverable" + "/" + "image_compression_time.csv"
merge_csv_files(csv_list, output_csv_path)
...
output_csv_path = "/Users/abdurrouf/edge-computing/image_transfer/report_generation/deliverable" + "/" + "image_decompression_time.csv"
merge_csv_files(csv_list, output_csv_path)
